...
TWEAK_NAME = NotifyBubbles NotifyBubblesKeyboard
...
NotifyBubblesKeyboard_FILES = Sources/NFBDarkKeyboard.m
NotifyBubblesKeyboard_CFLAGS = -fobjc-arc -Wall -Wextra
NotifyBubblesKeyboard_FRAMEWORKS = UIKit Foundation
NotifyBubblesKeyboard_LIBRARIES = substrate
