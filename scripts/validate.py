...
assert 'Sources/NFBSwitcher.m' in (root / 'Makefile').read_text(), 'Update the root Makefile for 0.17.0.'
...
assert 'Wno-error=deprecated-declarations' in (root / 'Makefile').read_text(), \
    'NotifyBubblesBack must keep deliberate legacy-API deprecation warnings non-fatal.'
