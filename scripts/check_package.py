...
for argument in sys.argv[1:]:
    ...
    for suffix in ['NotifyBubblesBack.dylib', 'NotifyBubblesBack.plist', 'NotifyBubbles.dylib', 'NotifyBubbles.plist', 'NFBPreferences.bundle/NFBPreferences', 'NFBPreferences.bundle/Root.plist']:
